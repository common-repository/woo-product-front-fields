...
abstract class WP_REST_Controller {
	...
	protected function add_additional_fields_to_object( $object, $request ) {
		...
		foreach ( $additional_fields as $name => $field_options ) {

			if ( ! $field_options['get_callback'] ) {
				continue;
			}

			$object[ $name ] = call_user_func( $field_options['get_callback'], $object, $name, $request, $this->get_object_type() );
		}
	...
	protected function update_additional_fields_for_object( $object, $request ) {
		...
		foreach ( $additional_fields as $name => $field_options ) {
			...
			call_user_func( $field_options['update_callback'], $request[ $name ], $object, $name, $request, $this->get_object_type() );
		}
	}
	...
	protected function add_additional_fields_schema( $schema ) {
		...
		foreach ( $additional_fields as $name => $field_options ) {
			...
			$schema['properties'][ $name ] = $field_options['schema'];
		}
