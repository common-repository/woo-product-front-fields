...
class WPF_Textarea_Widget extends WPF_Base_Widget {  
  ...
  public function element_render() {
    ...
    <?php else : ?>
      <textarea type='text' class='wpf-widget-input' name='<?php echo $this->name; ?>' data-id=<?php echo $this->id; ?> <?php echo wpf_attributes( $this->attributes ); ?>><?php echo $this->value; ?></textarea>
