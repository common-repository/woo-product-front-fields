...
class CMB2_REST extends CMB2_Hookup_Base {
	 ...
	 * @return mixed
	 */
	public static function get_post_rest_values( $object, $name, $request, $object_type ) {
		if ( 'cmb2' === $name ) {
	 ...
	 * @return mixed
	 */
	public static function get_user_rest_values( $object, $name, $request, $object_type ) {
		if ( 'cmb2' === $name ) {
	 ...
	 * @return mixed
	 */
	public static function get_comment_rest_values( $object, $name, $request, $object_type ) {
		if ( 'cmb2' === $name ) {
	 ...
	 * @return mixed
	 */
	public static function get_term_rest_values( $object, $name, $request, $object_type ) {
		if ( 'cmb2' === $name ) {
	 ...
	 * @return bool|int
	 */
	public static function update_post_rest_values( $values, $object, $name, $request, $object_type ) {
		if ( 'cmb2' === $name ) {
	 ...
	 * @return bool|int
	 */
	public static function update_user_rest_values( $values, $object, $name, $request, $object_type ) {
		if ( 'cmb2' === $name ) {
	 ...
	 * @return bool|int
	 */
	public static function update_comment_rest_values( $values, $object, $name, $request, $object_type ) {
		if ( 'cmb2' === $name ) {
	 ...
	 * @return bool|int
	 */
	public static function update_term_rest_values( $values, $object, $name, $request, $object_type ) {
		if ( 'cmb2' === $name ) {
