...
class WPF_Date_Widget extends WPF_Base_Widget {  
  ...
  public function element_render() {
    ...
    <?php if ( $this->is_admin_form ) : ?>        
      ...
      <div class="override" style="display:<?php echo $this->is_overridden_value ? 'block' : 'none' ?>;">
        <input type='text' class='wpf-widget-input wpf-field-value wpf-date' name='<?php echo $this->name; ?>' value='<?php echo $this->value; ?>' />
      </div>
    ...
    <?php else : ?>
      <input type='text' class='wpf-widget-input wpf-date' name='<?php echo $this->name; ?>' data-id=<?php echo $this->id; ?> value='<?php echo $this->value; ?>' <?php echo wpf_attributes( $this->attributes ); ?> />  
